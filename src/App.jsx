  ...
  return (
    <div className="min-h-screen flex flex-col bg-[#FAF8F5] text-[#1E2229] relative selection:bg-[#9B3F23] selection:text-white">
      ...
      <div className="fixed bottom-5 right-5 z-40 flex flex-col items-end gap-2.5 pointer-events-none">
        ...
        {/* Floating Admin & Leads Quick Action */}
        <button
          onClick={() => setIsAdminModalOpen(true)}
          className="pointer-events-auto bg-[#1E2229] text-amber-200 hover:text-white text-[11px] font-bold py-1.5 px-3 rounded-full shadow-lg border border-gray-700 hover:bg-black transition-all flex items-center gap-1.5 hover:scale-105 cursor-pointer"
          title="Open Admin Control & Lead Tracking Portal (Points 18 & 19)"
        >
